...
### 📋 Результаты работы каждого запуска (логи `print(f...)` можно просмотреть в [GitHub Actions](https://github.com/AndrewShedov/vm-inspector/actions/runs/23198814588/job/67414797242):
